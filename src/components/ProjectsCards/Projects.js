const projects = [
    ...
    { 
        id: 8, 
        name: "Bot AI", 
        goal: "Implement an application where the user can chat with an AI model. Beyond this, the user should be able to give some feedback at each stage of the conversation.",
        focus: "HTML, CSS, JavaScript, ReactJS",
        plateform: ["Netlify"], 
        type: "Frontend",
        skills: ["HTML", "CSS", "JavaScript", "ReactJS",],
        detail: "https://www.crio.do/learn/me/ME_FE_XBOTAI_V2/ME_FE_XBOTAI_V2_MODULE_ONE/",
        figma: "https://www.figma.com/file/DYoSNliUDL3DlpgHPLlc0r/Bot-AI?type=design",
        doc: "NA",
        github:"https://github.com/Kamlesh-Sahu-R/xboatai", 
        page: "https://helpful-cactus-5524c7.netlify.app/",
        description: [
            "The user should be able to have multiple conversations.",
            "Once the user is done having that conversation, the chat gets saved an can be revisited from a panel on the side/top bar.",
            "While viewing a past conversation, the user able to see the feedback provided.",
            "Created a view where the user can see all feedback points across conversations and filter them based on rating.",
        ],
    },
    { 
        id: 9, 
        name: "XCruise", 
        goal: "Develop a static, responsive landing page for XCruise, i.e., a cruise booking company, using HTML and CSS.",
        focus: "HTML, CSS",
        plateform: ["Netlify"], 
        type: "Frontend",
        skills: ["HTML", "CSS",],
        ...
        description: [
            "XCruise is a responsive static website built from scratch using HTML and CSS.",
            "The project involved developing a responsive and interactive website that showcases various cruise destinations.",
            "Provides essential information about XCruise offerings.",
        ],
    },
